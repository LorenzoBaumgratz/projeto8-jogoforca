...
export default function Letras(props) {
    ...
    return (
        <div className="baixo">
            ...
            <div className="chute">
                Já sei a palavra!
                <input type="text" id="fname" name="fname" data-test="guess-input" value={chute} onChange={(e)=>setChute(e.target.value)}></input>
                <button type="button" data-test="guess-button" onClick={()=>chutar()}><p>Chutar</p></button>
            </div>
        </div>
    )
}